module.exports = function() {
  spawnAttackers = function(newroom, spawn, numberattackers) {
    ...
    if (attacker.length < numberattackers) {
      ...
      Game.spawns['Spawn1'].spawnCreep([MOVE, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE,
        ATTACK, ATTACK, ATTACK, ATTACK, ATTACK, ATTACK, ATTACK, ATTACK, ATTACK, ATTACK, ATTACK, ATTACK, ATTACK, ATTACK, ATTACK, ATTACK], namem, {
        memory: {
          role: 'attackerlol'
        }
      });
